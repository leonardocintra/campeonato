    ...
    return (
      <div className="container px-5 py-24 mx-auto">
        <div className="flex justify-center items-center">
          <h2 className="text-4xl text-center m-3">Jogos de hoje</h2>
          <span className="text-2xl">{`${new Date().getDate()} / ${
            new Date().getMonth() + 1
          ...
          <div className="flex flex-wrap w-full mb-20">
            <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
              <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">
                Campeonato Férias Ibiraci 2023
              </h1>
              <div className="h-1 w-20 bg-indigo-500 rounded"></div>
            </div>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">
              Bem-vindo ao Campeonato de Futsal! A emoção do esporte e a paixão
              dos jogadores se encontram em nossa pequena cidade. Junte-se a nós
              nessa competição intensa e torça pelos talentosos times locais.
              Viva cada momento do jogo, celebre a união da comunidade e
              descubra o espírito do futsal!
            </p>
          </div>
          {handleJogosHoje()}
